<?php $header = basename($_SERVER['PHP_SELF']); ?>
                    ...
                    <div class="header-top-lan-curr d-flex justify-content-end">
                        ...
                        <div class="header-top-curr dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="#">VNĐ đ</a></li>
                            </ul>
                        </div>
                        <!-- Currency End -->
                        <!-- Language Start -->
                ...
                <div class="col d-lg-none ">
                    <div class="ec-header-bottons">
                        ...
                        <a href="wishlist.html" class="ec-header-btn ec-header-wishlist">
                            <div class="header-icon"><img src="{{ url('assets/images/icons/wishlist.svg') }}"
                        ...
                        <a href="#ec-side-cart" class="ec-header-btn ec-side-toggle">
                            <div class="header-icon"><img src="{{ url('assets/images/icons/cart.svg') }}"
                                    class="svg_img header_svg" alt="" /></div>
                            <span class="ec-header-count cart-count-lable">3</span>
                        </a>
                        <!-- Header Cart End -->
                        <a href="javascript:void(0)" class="ec-header-btn ec-sidebar-toggle">
                            <img src="{{ url('assets/images/icons/category-icon.svg') }}" class="svg_img header_svg"
                                alt="icon" />
                        </a>
                        <!-- Header menu Start -->
                        <a href="#ec-mobile-menu" class="ec-header-btn ec-side-toggle d-lg-none">
                            <img src="{{ url('assets/images/icons/menu.svg') }}" class="svg_img header_svg"
                                alt="icon" />
                        </a>
                        <!-- Header menu End -->
                    </div>
                    ...
                    <div class="align-self-center">
                        <div class="header-logo">
                            <a href="{{ route('home') }}"><img
                                    src="{{ url('assets/images/logo/edit2-bear-logo-black.png') }}"
                                    alt="Site Logo" /><img class="dark-logo"
                                    src="{{ url('assets/images/logo/bear-logo-white.png') }}" alt="Site Logo"
                        ...
                        <div class="ec-header-bottons">
                            ...
                            <div class="ec-header-user dropdown">
                                <button class="dropdown-toggle" data-bs-toggle="dropdown">
                                    @if (Auth::check())
                                        @if ($_Auth->profile->avatar != null)
                                            <img src="{{ url('images/profiles') . '/' . $_Auth->profile->avatar }}"
                                                class="svg_img header_svg rounded-circle" alt="" />
                                        @else
                                            <img src="{{ url('images/profiles/default.jpg') }}"
                                                class="svg_img header_svg rounded-circle" alt="" />
                                        @endif
                                    @else
                                        <img src="{{ url('images/profiles/default.jpg') }}"
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    @if (!empty($_Auth->meta_value))
                                        @if ($_Auth->meta_value == 'Administrator')
                                            <li><a class="dropdown-item"
                                                    href="{{ route('admin.index', $_Auth->profile->username == null ? $_Auth->id : $_Auth->profile->username) }}">Admin
                                                    Page</a></li>
                                        @else
                                    ...
                                    @if (Auth::check())
                                        <li><a class="dropdown-item"
                                                href="{{ route('user.profile', $_Auth->id) }}">Profile</a></li>
    ...
    <div class="ec-header-bottom d-lg-none">
        <div class="container position-relative">
            <div class="row ">
                ...
                <div class="col">
                    <div class="header-logo">
                        <a href="{{ route('home') }}"><img src="{{ url('assets/images/logo/logo.png') }}"
                                alt="Site Logo" /><img class="dark-logo"
            ...
            <div class="row">
                <div class="col-md-12 align-self-center">
                    <div class="ec-main-menu">
                        @if ($header == 'home')
                            <a href="javascript:void(0)" class="ec-header-btn ec-sidebar-toggle">
                                <img src="{{ url('assets/images/icons/category-icon.svg') }}"
                                    class="svg_img header_svg" alt="icon" />
                            </a>
                        @endif
                        <ul>
                            <li><a href="{{ route('home') }}">Home</a></li>
                            <li class="dropdown position-static"><a href="{{ route('browse') }}">Browse</a>
                            </li>
                            <li class=""><a href="{{ route('blog') }}">Blog</a>
                            </li>
                            <li class="dropdown "><a href="{{ route('about') }}">About</a>
                                <ul class="sub-menu">
                                    <li class="{{ $header == 'contact' ? 'active' : null }}"><a
                                            href="{{ route('about.contact') }}">Contact Us</a></li>
                                    <li class="{{ $header == 'faq' ? 'active' : null }}"><a
                                            href="{{ route('about.faq') }}">FAQ</a></li>
                                    <li class="{{ $header == 'terms-and-conditions' ? 'active' : null }}"><a
                                            href="{{ route('about.terms-conditions') }}">Terms Condition</a></li>
                                    <li class="{{ $header == 'privacy-and-policy' ? 'active' : null }}"><a
                                            href="{{ route('about.privacy-policy') }}">Privacy Policy</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="hot-offer-noti"><span class="main-label-note-new" data-toggle="tooltip"
                                    title="NEW"></span><a href="{{ route('offer') }}">Hot Offers</a></li>
                            @if ($header == 'home')
                                <li class="dropdown scroll-to"><a href="javascript:void(0)"><img
                                            src="{{ url('assets/images/icons/scroll.svg') }}"
                    ...
                    <li><a href="javascript:void(0)">Categories</a>
                        <ul class="sub-menu">
                            ...
                            <li><a class="p-0" href="shop-left-sidebar-col-3.html"><img class="img-responsive"
                                        src="{{ url('assets/images/menu-banner/1.jpg') }}" alt=""></a>
                            </li>
                        </ul>
                    </li>
    ...
    <div class="ec-cart-inner">
        <div class="ec-cart-top">
            ...
            <ul class="eccart-pro-items">
                ...
                <li>
                    <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                            src="{{ url('assets/images/product-image/12_1.jpg') }}" alt="product"></a>
                    <div class="ec-pro-content">
