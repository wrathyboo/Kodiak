                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-3 ec-footer-contact">
                        <div class="ec-footer-widget">
                            <div class="ec-footer-logo"><a href="{{route('home')}}"><img src="{{url('assets/images/logo/edit-bear-logo-black.png')}}"
                                        alt=""><img class="dark-footer-logo" src="{{url('assets/images/logo/dark-logo.png')}}"
                            ...
                            <div class="ec-footer-links">
                                <ul class="align-items-center">
                                    ...
                                    <li class="ec-footer-link"><span>Call Us:</span><a href="tel:+440123456789">+44
                                            0123 456 789</a></li>
                                    <li class="ec-footer-link"><span>Email:</span><a href="https://loopinfosol.in/cdn-cgi/l/email-protection#81e4f9e0ecf1ede4c1e4e2ace4ece0e8edafe2eeec"><span class="__cf_email__" data-cfemail="371c524f565a475b527752541a525a565e5b1954585a">[email&#160;protected]</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col text-center footer-copy">
                        <div class="footer-bottom-copy ">
                            <div class="ec-copy">Copyright © 2021-2022 <a class="site-name text-upper"
                                    href="#">kody<span>.</span></a>. All Rights Reserved</div>
                        </div>
                    </div>
  ...
  <div class="ec-nav-toolbar">
    <div class="container">
        <div class="ec-nav-panel">
            ...
            <div class="ec-nav-panel-icons">
                <a href="index-2.html" class="ec-header-btn"><img src="assets/images/icons/home.svg"
